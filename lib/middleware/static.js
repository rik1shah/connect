...
var send = exports.send = function(req, res, next, options){
  ...
  fs.stat(path, function(err, stat){
    ...
    if (fn) {
      ...
      function reqClose(err){console.log("req closed"); callback(err)}
      function socketError(err){console.log("socket Errored"); callback(err)}
      function streamError(err){console.log("stream Errored"); callback(err)}
      function streamEnd(err){console.log("stream Ended"); callback(err)}
